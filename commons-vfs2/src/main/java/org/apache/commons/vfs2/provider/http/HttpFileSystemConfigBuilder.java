...
public class HttpFileSystemConfigBuilder extends FileSystemConfigBuilder {
	 ...
	 *
     * @param opts The FileSystemOptions.
	 * @return User provided Cookie Policy, otherwise default of: Commons-VFS
     * @since 2.2
     */
    ...
    /**
     * Sets the URL to the keystore containing the client certificate
     *
     * @param opts The FileSystemOptions.
    ...
    /**
     * Gets the password from the keystore
    ...
    /**
     * Sets the URL to the truststore
     *
     * @param opts The FileSystemOptions.
    ...
    /**
     * Gets the URL to the truststore
     *
     * @param opts The FileSystemOptions.
    ...
    /**
     * Sets the password to use for the truststore
     *
     * @param opts The FileSystemOptions.
    ...
    /**
     * Gets the password from the truststore
     * 
     * @param opts The FileSystemOptions.
     *
     ...
     *
     * @param opts The FileSystemOptions.
     * @param requestHeaders User provided request headers
     * @since 2.2
     */
    public void setRequestHeaders(final FileSystemOptions opts, final Map<String, String> requestHeaders) {
    	setParam(opts, KEY_REQUEST_HEADERS, requestHeaders);
    }
     ...
     * @param opts The FileSystemOptions.
     *
     * @return User provided request headers
     * @since 2.2
     */
